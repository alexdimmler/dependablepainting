/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8b9dd65341ac78161f595b4c48b3c66d)
// Runtime types generated with workerd@1.20250913.0 2025-08-29 
declare namespace Cloudflare {
	interface Env {
		PAINTER_KV: KVNamespace;
		DESTINATION: "alexdimmler@dependablepainting.work";
		SENDER: "no-reply@dependablepainting.work";
		ENVIRONMENT: "production";
		PAINT_BUCKET: R2Bucket;
		DB: D1Database;
		...
		GEO_QUEUE: Queue;
		LEAD_QUEUE: Queue;
		LEAD_NOTIFY_QUEUE: Queue;
		ORDER_SAVE_QUEUE: Queue;
		ORDER_RECEIPT_QUEUE: Queue;
		JOB_FINANCIALS_QUEUE: Queue;
		JOB_REMINDER_QUEUE: Queue;
